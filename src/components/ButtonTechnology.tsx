...
export const ButtonTechnology = (props : ButtonInterface) =>{
    return(
        ...
        className={classNames("h-[60px] transition-colors text-3xl font-mono w-[60px] text-gray-400 rounded-full flex items-center hover:border-white cursor-pointer justify-center border border-gray-500", {
